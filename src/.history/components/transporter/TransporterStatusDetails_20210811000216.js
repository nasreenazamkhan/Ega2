...
function TransporterStatusDetails(props) {
 ...
 {
   console.log("props.requestDetailsData " +props.requestDetailsData);
   console.log(props.requestDetailsData);
   booking=props.requestDetailsData;

 }

  useEffect(() => {
    console.log(booking.containerList);
    containerInProgress =booking.containerList.filter( (container) =>
    container.refStatus.code ==="INPRO" || container.refStatus.code ==="INPRO" || container.refStatus.code ==="PODUPL" 
            ...
            <Table>
              <TableRow>
                ...
                <TableCell>
                  ...
                  <InputLabel>{booking.transporterAmount}</InputLabel>
                </TableCell>
                <TableCell>
                  <InputLabel style={{ color: "#757575" }}>
                    Requestor Company
                  </InputLabel>
                  <InputLabel>{booking.requestorCompany}</InputLabel>
                </TableCell>
                <TableCell>
                  <InputLabel style={{ color: "#757575" }}>
                    Expires In
