...
{invoice.status==='Invoice Rejected'?<img src="./reUploadDocs.png" style={{height:'50px',marginTop:'15px'}}></img>:<img src="./uploadSupDoc.png" style={{height:'70px',marginTop:'7px'}}></img>}
    ...
    */}
    ...
    <TableRow>
        <TableCell>  <InputLabel style={{fontSize:'21px',color:'#000000',fontFamily:'Dubai Regular'}}>Gross Amount</InputLabel></TableCell>
        <TableCell>  <InputLabel style={{fontSize:'21px',color:'#000000',fontFamily:'Dubai Regular'}}>{requestDetailsData.grossAmount} + " AED"</InputLabel></TableCell>
        </TableRow>
    </TableBody>
    </Table>
           </Grid>
