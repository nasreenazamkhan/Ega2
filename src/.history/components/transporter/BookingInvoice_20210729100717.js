...
{invoice.status==='Invoice Rejected'?<img src="./reUploadDocs.png" style={{height:'50px',marginTop:'15px'}}></img>:<img src="./uploadSupDoc.png" style={{height:'70px',marginTop:'7px'}}></img>}
    ...
    */}
    ...
    <TableRow>
        ...
        <TableCell style={{borderBottom:'none'}}>  <InputLabel style={{fontSize:'18px',color:'#0568AE',fontFamily:'Dubai Regular',float:'right'}}>{requestDetailsData.grossAmount} AED</InputLabel></TableCell>
        </TableRow>
    </TableBody>
    </Table>
           </Grid>
