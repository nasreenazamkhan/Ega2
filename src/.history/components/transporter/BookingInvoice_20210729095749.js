...
function BookingInvoice(props) {
    ...
    const formValues = {
      ...
      const uploadInvoices=(invoicelist)=>
      {
        ...
        //    TransporterService.uploadMiscellaneousInvoices(invoiceL).then((res) => {
        //      console.log("res",res);
...
{invoice.status==='Invoice Rejected'?<img src="./reUploadDocs.png" style={{height:'50px',marginTop:'15px'}}></img>:<img src="./uploadSupDoc.png" style={{height:'70px',marginTop:'7px'}}></img>}
    ...
    */}
    ...
    <InputLabel style={{fontSize:'21px',color:'#0E1B3D',fontFamily:'Dubai Medium',fontWeight:'bold'}}>Payment Breakup</InputLabel>
    </TableRow>
    <TableRow>
        <TableCell>  <InputLabel style={{fontSize:'21px',color:'#0E1B3D',fontFamily:'Dubai Medium',fontWeight:'bold'}}>Gross Amount</InputLabel></TableCell>
        <TableCell>  <InputLabel style={{fontSize:'21px',color:'#0E1B3D',fontFamily:'Dubai Medium',fontWeight:'bold'}}>Gross Amount1</InputLabel></TableCell>
        </TableRow>
    </TableBody>
    </Table>
           </Grid>
