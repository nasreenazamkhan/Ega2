...
{invoice.status==='Invoice Rejected'? <img src="./reUploadInv.png" style={{height:'50px',marginTop:'15px'}}/>:<img src="./uploadInvDisabled.png" style={{height:'70px',marginTop:'10px'}} />}
</label>
...
{invoice.status==='Invoice Rejected'?<img src="./reUploadDocs.png" style={{height:'50px',marginTop:'10px'}}></img>:<img src="./uploadSupDoc.png" style={{height:'70px',marginTop:'7px'}}></img>}
</label>
