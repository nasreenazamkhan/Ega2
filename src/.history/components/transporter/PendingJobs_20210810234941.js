            ...
            <Table>
              ...
              {booking.containerList.map((container, inx) => (
                <TableRow>
                  ...
                  {/* {container.refStatus.code === "CONF" && ( <TableCell>{container.</TableCell>)} */}
                  <TableCell>
                    ...
                    {container.refStatus.code === "TRUCK_ASGN" && (
                      ...
                      >
                        ...
                        <DialogContent>
                            Would you like to request a token for {container.assignedTruck} for {container.container_number}?
                        </DialogContent>
                    ...
                    {confirmJobpopup === true && <JobConfirmationPopUp
                       onClose={(e) => {
                        closeConfirmJobPopup();
                    }} 
