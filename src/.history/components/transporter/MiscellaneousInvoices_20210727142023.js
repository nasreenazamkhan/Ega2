...
{invoice.status==='Invoice Rejected'? <img src="./reUploadInv.png" style={{height:'80px',marginLeft:'-5px'}} />:<img src="./uploadInvDisabled.png" style={{height:'70px',marginTop:'10px'}} />}
</label>
