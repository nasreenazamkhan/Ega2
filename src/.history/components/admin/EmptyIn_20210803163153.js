  ...
  const validate = (container,job) => {
    ...
    console.log("validate job:: ", container);
      ...
      if (
       ...
       ( container.preferredDate!==undefined ||    container.preferredDate!=='' )&&
        container.etokenDto
      ) {
                    ...
                    {jobs.containerList.map((container, inx) => (
                      <TableRow>
                        ...
                        <ApplnDatePicker name={"date"} iconColor="#1FA5FF" disablePastDate={true}  
                                value={container.preferredDate}
                             onChange={(e) => {
                            container.preferredDate = methods.getValues().date;
                              console.log("date new ", container.preferredDate);
