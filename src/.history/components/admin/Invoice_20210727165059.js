...
function Invoice(props) {
   ...
   const downloadFile=(invoice)=>
    ...
    return (
       ...
       <Link style={{fontSize:'16px',color:'#000000',fontFamily:'Dubai Regular',fontWeight:'bold'}}   onClick={() => {downloadFile(invoice.invoice)}}>{invoice}
       ...
       (
        <Grid item xs={4} sm={2}>
        <Link style={{fontSize:'16px',color:'#000000',fontFamily:'Dubai Regular',fontWeight:'bold'}}   onClick={() => {downloadFile(invoice.invoiceDoc[ind])}}>{invoiceDoc.fileName}
        </Link>
        </Grid>
       )) 
       ...
       <Grid item xs={4} sm={2}>
           ...
           {invoice.status==='Invoice Submitted' &&  <Grid item container xs={12} sm spacing={1}>
             <Grid item xs={6} sm={2}>
                 <LabelHeader
                >
                 Invoice Number
