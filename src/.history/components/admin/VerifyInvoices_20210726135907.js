      ...
      >
        <Table style={{height:'15px'}}>
          <TableBody>
            ...
            <Box style={{width:'150px',border:'1px solid black'}} component="span"  className={`${activateMisc} miscellaneous`} onClick={() => {activateOption("misc")}}>
                                    <Typography variant="caption">MISCELLANEOUS</Typography>
                                </Box>
                                <Box style={{width:'150px',border:'1px solid black'}} component="span"  className={`${activateBooking} booking`} onClick={() => {activateOption("booking")}}>
                                    <Typography variant="caption">BOOKING</Typography>
                                </Box>
                                <Box style={{width:'150px',border:'1px solid black'}} component="span"  className={`${activateContainer} containerList`} onClick={() => {activateOption("container")}}>
