...
function VerifyInvoices(props) {
  ...
  const [activateContainer, setAcitvateContainer] = useState("");
        ...
        <Table style={{height:'15px'}}>
          <TableBody>
            <TableRow key={job.referenceNumber}>
              <TableCell style={{borderBottom:'1px solid #D3D3D3',height:'20px'}}>
            ...
            <Box style={{width:'150px',border:'1px solid black'}} component="span"  className={`${activateMisc} miscellaneous`} onClick={() => {}}>
                                ...
                                <Box style={{width:'150px',border:'1px solid black'}} component="span"  className={`${activateContainer} containerList`} onClick={() => {}}>
