...
import RequestBoeService from "../../service/RequestContainerService";
import RequestDetailsService from "../../service/RequestBoeService";
...
useEffect(() => {
  RequestBoeService.fetchRequestDetailsWithDocuments(props.referenceNumber).then((response) => {
