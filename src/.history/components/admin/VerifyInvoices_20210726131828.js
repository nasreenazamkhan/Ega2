...
function VerifyInvoices(props) {
  ...
  const [activeBooking, setActivateBooking] = useState("active");
      ...
      >
        <Table style={{height:'15px'}}>
          <TableBody>
            ...
            <Box component="span"  className={`${activateMisc} miscellaneous`} onClick={() => {}}>
                                    <Typography variant="caption">MISCELLANEOUS</Typography>
                                </Box>
                                <Box component="span"  className={`${activeBooking} booking`} onClick={() => {}}>
                                    <Typography variant="caption">BOOKING</Typography>
                                </Box>
                                <Box component="span"  className={`${activateContainer} containerList`} onClick={() => {}}>
