    ...
    return (
       ...
       <Grid item xs={4} sm={2}>
              ...
              <Grid item xs={4} sm={2}>
               ...
               {props.payment &&  invoice.status==='Invoice Approved' &&  (invoice.paymentStatus.includes('PAID IN ADVANCE')
             ...
             Settled On
                 ...
                 <ApplnDatePicker name={"settledOn"} iconColor="#1FA5FF" disablePastDate={true}  
                 height="40px" width="170px"     value={invoice.settledOn}
                             
                 onChange={(e) => {
                   invoice.settledOn = methods.getValues().settledOn;
                    ...
                    onClick={() => {
                      invoice.status="Settled";
                        BookingService.updateSettledOnDate(invoice).then((res) => {
                  ...
                  >
                    ...
                    {props.payment &&  invoice.status==='Invoice Settled' &&  <Grid item xs={4} sm={2}>
                       <LabelHeader   
                 >
             Settled On 
                 </LabelHeader>
