      ...
      >
        <Table style={{height:'15px'}}>
          <TableBody>
            ...
            <Box style={{width:'150px',border:'1px solid black'}} component="span"  className={`${activateMisc} miscellaneous`} onClick={() => {
              setActivateMisc("active");setActivateBooking("");setActivateContainer("");
              setInvoiceList(invoiceList.filter(x=>x.invoiceType==='TRANSINV'))
              }}>
                                    <Typography variant="caption">MISCELLANEOUS</Typography>
                                </Box>
                                <Box style={{width:'150px',border:'1px solid black'}} component="span"  className={`${activateBooking} booking`} onClick={() =>
                                  {setActivateMisc("");setActivateBooking("active");setActivateContainer("");
                                  setInvoiceList(invoiceList.filter(x=>x.invoiceType==='BOOKINGINV'))
                                  }}>
                                    <Typography variant="caption">BOOKING</Typography>
                                </Box>
                                <Box style={{width:'150px',border:'1px solid black'}} component="span"  className={`${activateContainer} containerList`} onClick={() => {setActivateMisc("");setActivateBooking("");setActivateContainer("active")}}>
