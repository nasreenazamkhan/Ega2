...
function VerifyInvoices(props) {
  ...
  const [activeMtIn, setActiveMtIn] = useState("");
  const [activeFclOut, setActiveFclOut] = useState("active");
      ...
      >
        <Table style={{height:'15px'}}>
          <TableBody>
            ...
            <Box component="span" className={`${activeMtIn} empty_in`} onClick={() => {}}>
                                    <Typography variant="caption">EMPTY  IN</Typography>
                                </Box>
              </Grid>
              </TableRow>
            </TableBody>
