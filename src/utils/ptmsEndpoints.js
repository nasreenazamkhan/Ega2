...
export const downloadReceipt =
  "/ptms/app/api/secure/certificate/paymentReceipt";
...
export const start = apiBaseUrl + "requestContainerDetails/start";
...
export const reInitialise = apiBaseUrl + "reinitializePayment";
...
export const termsAndConditionUrl = "https://dubaitrade.ae/en/lm-terms-conditions";
export const downloadInvoice = "/ptms/app/api/secure/certificate/paymentInvoice";
...
export const fetchRequestDetailsWithDocuments=apiBaseUrl+"admin/fetchRequestDetailsWithDocuments";
...
export const fetchHauliersCountForDTAdmin=apiBaseUrl+"/transporter/fetchHauliersCountForDTAdmin";
export const fetchInvoicesForPayment=apiBaseUrl+"/requestDetails/fetchInvoicesForPayment";
export const makePaymentForInvoices=apiBaseUrl+"/requestDetails/makePaymentForInvoice";
export const haulierList = apiBaseUrl + 'transporter/fetchHaulierList';
export const saveOrUpdateRateCard = apiBaseUrl + 'transporter/saveOrUpdateRateCard';
export const saveHaulier = apiBaseUrl + 'transporter/saveHaulier';
export const downloadInvoiceReceipt ="/ptms/app/api/secure/certificate/invoiceReceipt";
export const adminSearchRequest = apiBaseUrl + 'admin/searchRequest';
export const fetchTrackDetails=apiBaseUrl+"/requestDetails/fetchTrackDetails";
export const fetchAirports=apiBaseUrl+"/requestDetails/fetchAirports";