...
import {
    IconButton, Icon, TablePagination, TableSortLabel, TextField, Tooltip, CircularProgress, Checkbox, Grid,
    Typography,
    Avatar
        ...
        // } 
            ...
            return (
                <StyledTableCell align="left" key={index} >
                    <Link
                        style={{ textDecoration: "underline", color: row.openCollapsePanel ? '#fff' : '' }}
                        onClick={() => {
                ...
                <HeaderTableRow key={extIndex} selected={open} >
                    ...
                    {chkbox === true ?
                        <StyledTableCell style={{
                            width: '27px', paddingRight: '0px', borderLeft: leftBorder ? headerRowLeftBorderChk : headerRowLeftBorderUnchk
                        }}
                        >



                            <Radio checked={row.referenceNumber !== radioSelected ? false : true} onClick={(evnt: any) => {
