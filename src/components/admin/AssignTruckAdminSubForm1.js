...
function AssignTruckAdminSubForm(props) {
  ...
  const [defaultTransporter,setDefaultTransporter]=React.useState({label:props.containerData.transporterName,value:props.containerData.transporterCode})
  const [defaultTruck,setDefaultTruck]=React.useState({label:props.containerData.assignedTruck,value:props.containerData.assignedTruck})
  //const [defaultTransporter,setDefaultTransporter]=React.useState({ label: "The Godfather", value: "1972" })
  ...
  const onTruckSelect = (e) => {
    setTruckNumber(e);
    containerData.assignedTruck = e.split(',')[0];
