...
export default function AssignTruckPopup(props: any) {
    ...
    const handleConfirm = () => {
        ...
        formvalues.etokenDto.fileContent !== undefined ? setDocError(false) : setDocError(true)
        if (formvalues.etokenDto.fileContent !== undefined) {
    ...
    const validationSchema = Yup.object({
        transporterCode: Yup.string().required("Transporter details is required"),
        assignedTruck: Yup.string().required("Truck number is required"),
        tokenNumber: Yup.string().required("Token Number is required"),
        fromTime: Yup.string().required("From time is required"),
        toTime: Yup.string().required("To time is required"),
        tokenDate: Yup.string().when('tokenType', () => {
            if (formvalues.tokenType == 'MT IN')
                return Yup.string().required("Token Date Required")
        }),
    });
    ...
    return (
        <Dialog
            ...
            open={open}
            PaperProps={{
                style: { borderRadius: '0px', minWidth: '650px', minHeight: '502px' }
            }}
        >
            ...
            <FormProvider {...methods}>
                <form autoComplete="off" onSubmit={methods.handleSubmit(handleConfirm)}>
                    <DialogContent style={{ padding: '18px', paddingBottom: '0px' }}>
                        <Table>
                            <TableBody>
                                    ...
                                    <StyledTableCell colSpan={2} className={classes.cellDesign}>
                                        <ApplnAutoCompleteAsync
                                            ...
                                            onSelectMenu={(option: any) => {
                                                ...
                                                setTransporter({ label: option.label, value: option.value });
                                            }}
                                        />
                                    </StyledTableCell>
                                    <StyledTableCell colSpan={2} className={classes.cellDesign}>
                                        <ApplnAutoCompleteAsync
                                            ...
                                            onSelectMenu={(option: any) => {
                                                ...
                                                setTruckNumber({ label: option.label, value: option.value });
                                ...
                                <TableRow>
                                    <StyledTableCell className={classes.cellDesign} style={{ paddingRight: '0px', width: '190px' }}>
                                        ...
                                        <Grid item xs={12}>
                                            <CssTextField
                                                ...
                                                variant="outlined"
                                                error={methods.errors.tokenNumber}
                                                helperText={methods.errors.tokenNumber?.message??" "}
                                                style={{ width: '150px' }}
                                    ...
                                    <StyledTableCell className={classes.cellDesign} style={{ paddingLeft: '0px', paddingRight: '0px', width: '170px' }}>
                                        ...
                                        <Grid container spacing={2}>
                                            <Grid item xs={6}>
                                                <CssTextField
                                                    ...
                                                    variant="outlined"
                                                    name="fromTime"
                                                    error={methods.errors.fromTime}
                                                    helperText={methods.errors.fromTime?.message??" "}
                                                    type="time"
                                                    fullWidth
                                            ...
                                            <Grid item xs={6}>
                                                <CssTextField
                                                    ...
                                                    fullWidth
                                                    placeholder="hh:mm"
                                                    error={methods.errors.toTime}
                                                    helperText={methods.errors.toTime?.message??" "}
                                                    name="toTime"
                                                    type="time"
                                ...
                                <TableRow>
                                    <StyledTableCell colSpan={3} className={classes.cellDesign} style={{ minWidth: '370px' }}>
                                        ...
                                        <Grid item xs={12}>
                                            <CssTextField
                                                ...
                                                onChange={(e) => {
                                                    ...
                                                    formvalues.etokenDto.adminComments = e.target.value;
                                    ...
                                    <StyledTableCell className={classes.cellDesign} >
                                        <Grid container spacing={1} style={{ paddingTop: '25' }}>
                                            <Grid item xs={2}>
                                                {!success && <img src="./upload-icon-small.svg" />}
                                                {success && <img src="./token_success.svg" height="38px" />}
                                            </Grid>
                                            ...
                                            {docError && <span style={{ color: '#f44336' }}>
                                                Please upload e-token to update.
                                            </span>}
                                        </Grid>
                                        {uploadDocumentPopup &&
                                            <UploadDocumentPopup
