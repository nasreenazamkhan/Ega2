...
function JobCard(props) {
  ...
  const LabelDataContainers = withStyles(() => ({
    root: {
      fontSize: "16px",
      fontWeight: "bold",
      color: "#000000",
  ...
  const validateContainerData = (containerData) => {
    ...
    for (let i = 0; i < containerData.containerList.length; i++) {
      ...
      if (
        ...
        (container.tokenInSlotFrom === '' || container.tokenInSlotFrom === undefined || container.tokenInSlotTo === '' || container.tokenInSlotTo === undefined) &&
        (container.etokenDto.fileName === null)
      ) {
      ...
      if (container.preferredTokenInDate === '' || container.preferredTokenInDate === undefined) {
      ...
      if (container?.etokenDto?.fileName === null) {
      ...
      <FormProvider {...methods}>
        <Button
          ...
          onClick={() => {
            ...
            if (jobs.containerList.every(x => x.empty === true)) {
              console.log("inside every")
              setShowToaster('NO_INPUT');
            }
            else if (success) {
          ...
          >
            ...
            <Table>
              <TableBody>
                ...
                {jobs.containerList.map((container) => (
                  <TableRow>
                    <TableCell>
                      <Link
                        style={{
                      ...
                      <span style={{ color: '#848484', fontFamily: 'Dubai Regular', fontSize: '16px' }}>
                         {` - ${container.iso_code}`}
                      </span>
                    </TableCell>
                    <TableCell>
                    ...
                    <TableCell>
                      <Grid container>
                        <Grid item xs={2}>
                          {!container.upload && <IconButton onClick={() => {
                            setSelectedContainer(container);
                            setUploadDocumentPopUp(true);
                          }}>
                            <img src="./token_upload.svg" id={container.container_number} alt="Not available" height="28px" />
                          </IconButton>}
