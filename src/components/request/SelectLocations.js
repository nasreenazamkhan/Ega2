...
console.log(requestDetails)
  ...
  function DataForm(props) {
    ...
    const handleUpdateLocation = (updatedContainer) => {
      console.log("handleUpdateLocation")
      console.log(updatedContainer)
      containers.containerList.forEach((container,index)=>{
        if(container.container_number==updatedContainer.container_number){
          containers.containerList[index]=updatedContainer;
        }
      })
    ...
    const deleteContainer = (containerNumber) => {
      ...
      if (containers.containerList.length > 1) {
        ...
        containers.containerList.splice(deleteContainer, 1);
        console.log(containers);
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} style={{ marginLeft: '20px', paddingBottom: '0px', marginBottom: '-18px' }}>
              <span style={{ fontSize: "14px", fontWeight: "bold", marginRight: '20px', color: '#0E1B3D', paddingBottom: '0px' }}>
                Displaying {(containers && containers.containerList) ? containers.containerList.length : 0} containers
              </span>
            </Grid>
          </Grid>
