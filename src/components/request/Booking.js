  ...
  return (
    <>
      ...
      {draftCount > 0 && (
        <InfoBox
          ...
          onSelect={(e) => {
            console.log(e)
            if (e === 'Drafts') {
              history.push("/drafts",{ url: boeDetailsUrl});
            }
          }}
        >
        </InfoBox>)}
      <Grid container alignItems="flex-end">
          ...
          <OutlinedInput
            ...
            endAdornment= { searchValue && (
              <IconButton
                onClick={() => {
                  setSearchValue("");
                  setBoeDetailsUrl(remoteboeDetailsUrl);
                  setPstate(pstate+1)
                }}
        ...
        <Grid item xs={4} >
          <Button
            style={{float: "right", fontFamily: "Dubai Regular"}}
            variant="outlined"
            onClick={() => {
              setShowSmartSearch(!showSmartSearch);
            }}
          ><img src="./add_filters.svg" style={{paddingRight:'5px'}}/>
              Add Filters
          </Button>
        </Grid>
      </Grid>
            ...
            style={{float: "right"}}
              onClick={() => {
                ...
                history.push("/createRequest", {
                  containerData: {containerList : selectedRows},
                   url: boeDetailsUrl
                });
              }}
            >
