...
function PaymentConfirmation(props) {
  ...
  const refNumber = props.bookingNumber;
        ...
        <DialogContent>
          {success === 'Y' &&
            <div className={classes.root}>
              ...
              <Typography style={{ color: '#606060' }}>{`An Email Confirmation will be sent to you shortly for the miscellaneous payment done on booking number # ${refNumber}`}</Typography>
              <Grid container>
