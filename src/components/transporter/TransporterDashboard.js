        ...
        <Grid item xs={5}>
          <Card className={classes.cardStyle}>
            <CardContent>
              ...
              <LabelHeader>Click to view all jobs currently available </LabelHeader>
            </CardContent>
          </Card>
        ...
        <Grid item xs={5} style={{ marginLeft: "93px" }}>
          <Card className={classes.cardStyle}>
            <CardContent>
              ...
              <hr className={classes.hrStyle} />
              <LabelHeader>Click to view your ongoing jobs</LabelHeader>
            </CardContent>
          </Card>
          <div style={{ textAlign: "center", marginTop: "-53px" }}>
            <IconButton
          ...
          <Card className={classes.statusCardStyle}>
            <CardContent>
              <Grid container spacing={1} alignItems="center">
                ...
                <Grid item xs={6} style={{ marginTop: "40px", marginLeft:'10px' }}>
                  <div className="row">
