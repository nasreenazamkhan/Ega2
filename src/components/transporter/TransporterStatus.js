...
import { Grid, Link, InputLabel, IconButton, Icon, InputAdornment, OutlinedInput, makeStyles, Breadcrumbs } from "@material-ui/core";
...
function TransporterStatus() {
  ...
  return (
    <>
              ...
              <OutlinedInput
                ...
                endAdornment={
                  <InputAdornment >
                    <IconButton onClick={() => {
                      setSearchValue("");
                      setRequestDetailsUrl("/ptms/app/api/secure/requestDetails/bookingForTransporter");
                      setPstate(pstate + 1);
                    }}>
                      <Icon >clear</Icon>
                    </IconButton>
      ...
      <Grid item xs={12} style={{ marginBottom: '30px', marginTop: '10px' }}>
