    ...
    return (
     ...
     <span style={{ fontSize: "22px",color:'#5E5E5E' ,fontFamily:'Dubai Medium' }}>
          ...
          <span style={{ fontSize: "22px",color:'#0E1B3D',fontFamily:'Dubai Medium' }}>
            ...
            <Grid container>
            <Grid item>
            <p style={{ fontSize: "20px",color:'#0E1B3D',fontFamily:'Dubai Medium' }}>Please note:All fields are mandatory!Incomplete token details will not be updated for the container in the system</p>
            </Grid>
            </Grid>
      <br></br>
            <br></br>
