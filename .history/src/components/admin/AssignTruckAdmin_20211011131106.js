            ...
            <Grid item>
              <SearchIcon
                ...
                onClick={() => {
                  ...
                  if (searchValue === "") 
                  {
                    var container_containerData=containerData.containerList[0];
                    var indexReplace=containerDataOrigin.containerList.findIndex((e) => e.container_number === container_containerData.container_number);
