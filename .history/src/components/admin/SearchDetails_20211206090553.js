...
export default function SearchDetails(props) {
    ...
    const validationSchema = Yup.object().shape({
        ...
        transporterName: Yup.string().required('Transporter Required'),
        dropDate: Yup.string().required('Date Required'),
        dropTime: Yup.string().required('Time Required'),
    ...
    const doSearch = (value, type) => {
        BookingService.getBookingByNumber(value, true).then((res) => {
            if (res && res?.status === "success") {
                ...
                methods.setValue("dropTime",  time);
 ...
 <FormControl  error={Boolean(methods.errors?.noOfTrucks)} >
                                            ...
                                            {!data?.multiLocAndTime && <>
                                                ...
                                                <StyledTableCell align="left" style={{ paddingTop: '20px' }}>
                                                    ...
                                                    <FormControl  error={Boolean(methods.errors?.dropTime)} >   
                                                        <BootstrapInput
                                                            id="toTime"
                                                            name="dropTime"
                                                            type="time"
                                                            ...
                                                            onChange={(e) => {
                                                                ...
                                                                setFormvalues(formvalues);
                                                                methods.setValue('dropTime', e.target.value, { shouldValidate: true })
                                                                console.log(methods.getValues())
                                                            }}
                                                        />
                                                         <FormHelperText>{ methods.errors?.dropTime?.message
                                                                  ? methods.errors.dropTime.message
                                                                  : ""}</FormHelperText>
                                                        </FormControl>
