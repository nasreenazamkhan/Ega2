...
import { IconButton, Icon, InputAdornment, OutlinedInput ,Grid,Link} from "@material-ui/core";
...
const useOutlinedInputStyles = makeStyles(theme => ({
  root: {
    ...
    '&:hover $notchedOutline':{
      ...
      boxShadow: '0px 0px 5pximport { COLUMN_TYPE_DATE } from './../../lib_old/common/Constants';
 #00000029',
    },
    "& .MuiInputBase-input": {
          ...
          <OutlinedInput
            ...
            endAdornment= {
              <InputAdornment >
                <IconButton onClick={()=>{
                  setSearchValue("");
                  setRequestDetailsUrl("/ptms/app/api/secure/requestDetails/fetchRequestDetailsSummary?statusCode=EXPIRED");
                  setPstate(pstate + 1);}}>
                <Icon >clear</Icon>
                </IconButton>
              </InputAdornment>
