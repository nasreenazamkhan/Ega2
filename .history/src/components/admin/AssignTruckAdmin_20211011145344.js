...
<JobConfirmationAdmin
      ...
      <div className="row">
        ...
        <Grid container alignItems="flex-end">
            <Grid item>
            <img src="./information-button.svg" height="10px" />
              </Grid>
            <Grid item>
            <p style={{ fontSize: "18px",color:'#0E1B3D',fontFamily:'Dubai Medium',marginLeft:'10px' }}>Please note:All fields are mandatory! Incomplete token details will not be updated for the container in the system</p>
            </Grid>
            <hr
