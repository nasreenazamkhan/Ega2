...
export default function SearchDetails(props) {
    ...
    const validationSchema = Yup.object().shape({
        ...
        isTransporterAssigned:Yup.boolean,
        timeInterval: Yup.string().required('Interval Required'),
        transporterName:  Yup.string().when('isTransporterAssigned', {
            is: (isTransporterAssigned) => true,
            then: Yup.string().required('Transporter  is required'),
        ...
        //   .of(
        //      Yup.object().shape({
        //       dayOfWeek: Yup.string().required("Name is required"),
        //        checked: Yup.boolean().required("Name is required"),
        //      })
        //    )
    ...
    const doSearch = (value, type) => {
        BookingService.getBookingByNumber(value, true).then((res) => {
            if (res && res?.status === "success") {
                ...
                //     dropTime: time
                // }
                console.log(res?.data?.dataItems[0])
                setFormvalues({
                    noOfTrucks: res?.data?.dataItems[0].noOfTrucks,
                    transporterName:  res?.data?.dataItems[0].assignedTransporterCode,
                    timeInterval:  res?.data?.dataItems[0].dropInterval,
                ...
                methods.setValue("noOfTrucks",res?.data?.dataItems[0].noOfTrucks);
                methods.setValue("transporterName", res?.data?.dataItems[0].assignedTransporterCode);
                methods.setValue("timeInterval",  res?.data?.dataItems[0].dropInterval);
                methods.setValue("isTransporterAssigned", res?.data?.dataItems[0].assignedTransporterCode?true:false);
                console.log("values ****", methods.getValues("noOfTrucks"));
 ...
 <FormControl  error={Boolean(methods.errors?.noOfTrucks)} >
                                            ...
                                            {!data?.multiLocAndTime && <>
                                                ...
                                                <StyledTableCell align="left" style={{ paddingTop: '20px' }}>
                                                    ...
                                                    <Grid item xs={12} style={{ color: '#000000', fontFamily: 'Dubai Regular' }}>
                                                        <FormControl className={classes.margin} error={Boolean(methods.errors?.timeInterval)}>
                                                            <Select
                                                                name={"timeInterval"}
                                                               defaultValue={formvalues.timeInterval}
                                                                ...
                                                                onChange={(e) => {
                                                                    ...
                                                                    setFormvalues(formvalues);
                                                                    methods.setValue('timeInterval', e.target.value, { shouldValidate: true })
                                                                }}
                                                                input={<BootstrapInput />}
                                                                inputProps={{
                                                                    inputRef: (ref) => {
                                                            ...
                                                            <FormHelperText>{ methods.errors?.timeInterval?.message
                                                                  ? methods.errors.timeInterval.message
                                                                  : ""}</FormHelperText>
                                                        </FormControl>
                                                    </Grid>
                                                </StyledTableCell>
                                        ...
                                        <TableRow style={{ paddingTop: '50px' }}>
                                            ...
                                            {data?.multiLocAndTime && <>
                                                ...
                                                <StyledTableCell align="left" style={{ paddingTop: '20px' }}>
                                                    ...
                                                    <Grid item xs={12} style={{ color: '#000000', fontFamily: 'Dubai Regular' }}>
                                                        <FormControl className={classes.margin} error={Boolean(methods.errors?.transporterName)}>
                                                            <Select
                                                                ...
                                                                onChange={(e) => {
                                                                    ...
                                                                    setFormvalues(formvalues);
                                                                    methods.setValue('transporterName', e.target.value, { shouldValidate: true })
                                                                }}
                                                                input={<BootstrapInput />}
                                                                inputProps={{
                                                                    inputRef: (ref) => {
                                                            ...
                                                            <FormHelperText>{ methods.errors?.transporterName?.message
                                                                  ? methods.errors.transporterName.message
                                                                  : ""}</FormHelperText>
                                                        </FormControl>
                                                    </Grid>
                                                </StyledTableCell></>} 
            ...
            <div style={{ marginTop: '20px' }}>
                ...
                <CustomizedDataTable
                    ...
                    handleClick={(row, index, action, element) => {
                        ...
                        methods.setValue("noOfTrucks", row.noOfTrucks);
                        methods.setValue("transporterName", row.assignedTransporterCode);
                        methods.setValue("timeInterval",  row.dropInterval);
                        methods.setValue("isTransporterAssigned", row.assignedTransporterCode?true:false);
                        console.log("method values",methods.getValues("isTransporterAssigned"))
