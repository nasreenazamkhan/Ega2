    ...
    const validateContainerData =(containerData)=>
  {
      ...
      for (let i = 0; i < containerData.containerList.length; i++) {
        ...
        if(
           ...
           (container.tokenOutSlotFrom===''|| container.tokenOutSlotFrom===undefined|| container.tokenOutSlotTo==='' || container.tokenOutSlotFrom===undefined) &&
           ...
           )
           {
            ...
            if(container.tokenOutSlotFrom===''|| container.tokenOutSlotFrom===undefined|| container.tokenOutSlotTo==='' || container.tokenOutSlotFrom===undefined)
            {
