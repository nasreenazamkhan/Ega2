import {
    ...
    InputBase, FormControl, Select, MenuItem, InputAdornment, FormHelperText, Typography, InputLabel
...
const schema = Yup.object().shape({
    dropDate: Yup.string().required("Drop Date Required")
...
export default function SearchDetails(props) {
    ...
    const validationSchema = Yup.object().shape({
        noOfTrucks: Yup.string().required('Required'),
  ...
  console.log("errors",methods.errors?.noOfTrucks);
...
<FormControl  error={Boolean(methods.errors?.noOfTrucks)} >
                                                     <Select
                                                       ...
                                                       {methods.errors?.noOfTrucks && <FormHelperText>Field is required</FormHelperText>}
                                                        </FormControl>
