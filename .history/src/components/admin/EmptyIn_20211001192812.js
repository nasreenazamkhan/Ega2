...
function JobCard(props) {
  ...
  const validate = (container, job) => {
    ...
    if (
      container.tokenIn &&
      container.tokenInSlotFrom !== undefined &&
      container.tokenInSlotTo !== undefined &&
      container.preferredTokenInDate &&
      container.etokenDto
    ) {
            ...
            <Table style={{ height: "15px" }}>
              <TableBody>
                <TableRow key={jobs.referenceNumber}>
                  ...
                  <TableCell style={{ borderBottom: "1px solid #D3D3D3",borderTop: "1px solid #D3D3D3" }}>
