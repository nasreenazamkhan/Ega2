...
<JobConfirmationAdmin
      ...
      <div className="row">
        ...
        <Grid container alignItems="flex-start">
            ...
            <Grid item>
            <p style={{ fontSize: "20px",color:'#0E1B3D',fontFamily:'Dubai Medium',marginLeft:'10px' }}>Please note:All fields are mandatory! Incomplete token details will not be updated for the container in the system</p>
            </Grid>
            </Grid>
      </div>
