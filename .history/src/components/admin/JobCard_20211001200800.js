        ...
        <Table>
                  <TableBody>
                    ...
                    {jobs.containerList.map((container, inx) => (
                      <TableRow >
                          <TableCell style={{borderBottom: '1px solid red',borderTop: '1px solid red',borderLeft:'1px solid red'}}>
                        <Link
                            style={{
                              fontSize:'18px',
                              fontFamily:'Dubai Regular',
                        ...
                        <TableCell style={{borderBottom: '1px solid red',borderTop: '1px solid red'}}>
                        <Link
                            style={{
                              fontSize:'18px',
                              fontFamily:'Dubai Regular',
