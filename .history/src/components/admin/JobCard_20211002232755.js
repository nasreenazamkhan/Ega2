      ...
      <Button
          ...
          onClick={() => {
            ...
            if(jobs.containerList.some(x=>x.valid===true))
             {
              setUpdatedContainers(jobs.containerList.filter(x=>x.valid===true).join(","));
          ...
          //     setShowToaster('SUCCESS');
          //     setReload(reload+1);    
          //     setUpdatedContainers(jobs.containerList.filter(x=>x.valid===true));
                  ...
                  <TableBody>
                    ...
                    {jobs.containerList.map((container, inx) => (
                      <TableRow >
                        ...
                        {!container.upload &&  <TableCell>
               
                              <img src="./token_upload.svg"   id={container.container_number} alt="Not available" onClick={()=>{
                                 setSelectedContainer(container);
                             ...
                             {container.upload &&  <TableCell>
                              <img src="./token_success.svg"  id={container.container_number} alt="Not available"/>
                            </TableCell>}
                              {showToaster1 && (
                                        <Toast
                                          icon="error"
...
{showToaster==='SUCCESS' && 
          ...
          message={"*Token Assigned Successfully for containers " + {updatedContainers} } 
                  ...
                  etokenDto.adminComments=response.comments;
                      ...
                      let promiseData = new Promise(
                        ...
                        promiseData.then((result) => {
                          ...
                          validate(selectedContainer,jobs);
