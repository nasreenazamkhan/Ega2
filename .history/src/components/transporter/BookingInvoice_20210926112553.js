...
function BookingInvoice(props) {
    ...
    const formValues = {
      ...
      transporterRemarks:''
       ...
       invoiceDate: Yup.string().required("invoice Number is required"),
       invoiceAmount: Yup.string().required("invoice Number is required"),
       vatAmount: Yup.string().required("invoice Number is required"),
       invoiceTotalAmount: Yup.string().required("invoice Number is required"),
       transporterRemarks: Yup.string().required("invoice Number is required"),
          ...
          <Grid item container xs={12} sm spacing={1}>
            <Grid item xs={6} sm={4}>
              ...
              <Grid item xs={6} sm={4}>
                ...
                height="40px" width="170px" value={ invoice.invoiceDate }  maxDate={todayDate}
