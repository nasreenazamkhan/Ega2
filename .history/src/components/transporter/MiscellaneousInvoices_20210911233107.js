      ...
      if(inv.submittedInvoice.status==='PAID' || inv.submittedInvoice.status==='Invoice Submitted' )
      {
        return (
         ...
         <Grid container>
          ...
          <Grid item>
          <InputLabel style={{color:'#FF8E0D',marginTop:'5px'}}> {inv.submittedInvoice.status==='PAID'?'Invoice  Submitted':inv.submittedInvoice.status}</InputLabel>
          </Grid>
          </Grid>
         </>
     ...
     <Grid item container xs={12} sm spacing={1}>
            <Grid item xs={6} sm={2}>
              ...
              <Grid item xs={6} sm={2}>
                ...
                helperText="this is helper test"             
                onChange={(e) => {
