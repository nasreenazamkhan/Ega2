      ...
      {<div className="row" style={{ marginBottom: '0px' }}>
        <div className="col-md-12">
          ...
          {tabSelected === "Miscellaneous" &&
            <MiscellaneousPayment statusData={location.state?.statusData} statusSelectedTab={location.state?.statusSelectedTab} paymentSummary={location.state?.paymentSummary}>
