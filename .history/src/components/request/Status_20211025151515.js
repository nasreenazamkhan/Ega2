...
import { Typography, Grid, OutlinedInput, makeStyles, InputAdornment, IconButton } from "@material-ui/core";
      ...
      BookingService.fetchRequestDetails(
        ...
        // ).then((response) => {
          history.push("/importerPayment", {
            statusData: requestData, payment: payment, success: success,
            referenceNumber: bookingNumber, showRecords: "PAYMENT_RESPONSE", url: requestDetailsUrl, statusSelectedTab: "MISCELLANEOUS INVOICES"
          })
        // })
      })
    }
