            ...
            <Table size="small">
              ...
              <TableRow>
                ...
                <TableRow>
                    ...
                    {((userType==='ADMIN') || (userType==='IMPORTER') ) &&  <InputLabel
                      style={{
                        color: "#0E1B3D",
                        fontSize: "24px",
                        fontFamily:"Dubai Medium"
                    ...
                    <>
                        ...
                        <TableBody>
                          {props.request.paymentDetails.paymentDetails.filter(x => x.paymentType !== 'tokenIn' && x.paymentType !== 'tokenOut').map((paymentInfo, ind) => (
                            <TableRow>
                              <TableCell>
                          ...
                          <TableRow>
                            ...
                            <TableCell>
                              <InputLabel style={{
                                ...
                                {props.request.paymentDetails.totalContainerTariff} AED
                              </InputLabel>
                            </TableCell>
                          </TableRow>
                        </TableBody>
                      ...
                      <Table className={classes.table}>
                        ...
                        {props.request.paymentDetails.paymentDetails.filter(x => x.paymentType === 'tokenIn' || x.paymentType === 'tokenOut').map((tokenDetails, ind) => (
                          <TableBody>
                            <TableRow>
                              <TableCell>
                                <InputLabel className={classes.labelData}>
                          ...
                          <TableRow>
                            ...
                            <TableCell>
                              <InputLabel style={{
                                ...
                                {props.request.paymentDetails.totalTokenTariff} AED
                              </InputLabel>
                            </TableCell>
                          </TableRow>
                        </TableBody>
                          ...
                          <TableRow>
                            ...
                            <TableCell>
                              <InputLabel style={{
                                ...
                                {props.request.paymentDetails.grossAmount} AED
                              </InputLabel>
                            </TableCell>
                          </TableRow>
                        </TableBody>
