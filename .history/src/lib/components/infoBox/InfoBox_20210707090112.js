               ...
               <Table size="small" style={{width:'100%'}}>
                 <TableBody>
                   <TableRow>
                     ...
                     <InputLabel style={{fontSize:'18px',color:'#333333',family:'Dubai Regular'}}>{props.message}</InputLabel>
                     </TableCell>
                   </TableRow>
                   <TableRow>
    <TableCell  colspan={5} style={{borderBottom:'0px'}}>

    </TableCell>
   
    {props.buttonNames.map((button) => (renderButtons(button)))}
