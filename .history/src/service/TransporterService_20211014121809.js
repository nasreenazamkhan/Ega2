...
class TransporterService {
    ...
    uploadInvoices(data){
        const remoteUrl = endpointContants.uploadInvoices;
        let obj = { url: remoteUrl ,body:data};
        return postHttp(obj, true).catch(error => {
            return error;
        });
    ...
    saveOrUpdateRateCard(data, haulierCode){
        const remoteUrl = endpointContants.saveOrUpdateRateCard+"?haulierCode="+haulierCode;
        let obj = { url: remoteUrl ,body:data};
        return postHttp(obj, true).catch(error => {
            return error;
        });
    ...
    saveHaulier(data){
        const remoteUrl = endpointContants.saveHaulier;
        let obj = { url: remoteUrl ,body:data};
        return postHttp(obj, true).catch(error => {
            return error;
        });
    ...
    fetchTrucks(data){
        const remoteUrl = `${endpointContants.fetchTrucksForTransporter}?transporter=${data}`;
        let obj = { url: remoteUrl ,body:data};
        return postHttp(obj, true).catch(error => {
            return error;
        });
